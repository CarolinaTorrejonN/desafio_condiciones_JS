...
verificar.addEventListener("click", function () { //funcion al hacer click//
    let cantidad1= parseInt (document.getElementById ("input1").value); //cantidad del imput izquierdo
    ...
    if (sumar > 10) {
      ...
      texto.innerHTML= "llevas" + " " + sumar + " " + "stickers"; //texto que muestra la cantidad//
    }
